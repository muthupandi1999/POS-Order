...
function NewDeliveryUser() {
  ...
  const [deliveryUserModal, setDeliveryUserModal] = useState(false);
      ...
      <div className="w-[90%]">
        <div className="flex justify-between items-center mx-auto flex-wrap">
          ...
          <div className="w-[50%] flex justify-end items-center">
            ...
            <DeliveryUserAdd
              heading="Add New Delivery User"
              deliveryUserModal={deliveryUserModal}
              setDeliveryUserModal={setDeliveryUserModal}
            /> */}
          </div>
        </div>
