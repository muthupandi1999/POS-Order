...
import DeptTagsAdd from "../../../components/modals/modalComponents/Restaurant/DeptTagsAdd";
import { DeptTagsList, TableLists } from "../../../utills/data";
...
function DeptTags() {
  ...
  const filteredTableData = TableLists?.filter((item) =>
      ...
      <div className="w-[90%]">
        <div className="flex justify-between items-center mx-auto flex-wrap">
          ...
          <div className="w-[50%] flex justify-between items-center">
            ...
            <DeptTagsAdd
              heading="Add New Department Tag"
              openModal={openModal}
