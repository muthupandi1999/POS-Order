...
import { BranchWiseTableData } from "../../../utills/data";
  ...
  return (
    <>
      {loading ? (
        <div className="p-4 my-element">
          <div className="flex items-center justify-between pb-4">
            <h4 className="font-bold text-xl pb-3">
              Branch Wise report for {currentOrder}
            </h4>
            <button
          ...
          <div className="py-3 border-b border-Secondary">
            <div className="flex items-center justify-between">
              ...
              <MoreIcon chartId={"stack9"} />
            </div>

            <div className="w-[100%] h-[650px] py-6 flex items-center justify-center">
              <Bar id="stack9" options={barChartOptions} data={BarChartData} />
              {/* {...props} */}
            </div>
          </div>
          ...
          <div className="overflow-x-auto  bg-Light my-8 h-auto rounded">
            <table className="table WorkPeriodTable table-xs table-pin-rows">
              ...
              <tbody className="overflow-hidden z-0">
                {BranchWiseTableData.map((e, index) => (
                  <tr key={e?.id}>
                    <td>{e?.id}</td>
                    <td>#{e?.token?.id}</td>
        ...
        <CircularProgress
          className="absolute m-auto top-0 left-[14%] right-0 bottom-0 "
          sx={{ color: "#454859" }}
        />
      )}
    </>
